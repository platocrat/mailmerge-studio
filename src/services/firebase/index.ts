...
const firebaseConfig = {
  ...
  authDomain: process.env.FIREBASE_AUTH_DOMAIN || 'mailmerge-studio.firebaseapp.com',
  projectId: process.env.FIREBASE_PROJECT_ID || 'mailmerge-studio',
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || 'mailmerge-studio.appspot.com',
